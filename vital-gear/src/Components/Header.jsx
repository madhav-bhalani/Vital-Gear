        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-5">
              ...
              <div className="group relative">
                ...
                <div className="group-hover:block bg-[#dae0ef] w-max pl-7 pr-10 py-5 text-left absolute top-full rounded-b-md z-10 hidden drop-shadow-sm">
                  <ul className="font-semibold text-lg text-[#112D4E] flex flex-col gap-3">
                    <NavLink to="/Proteins" state={"Proteins"} className="hover:text-[#3F72AF]">
                      Proteins
                    </NavLink>
                    <NavLink to="/Gainers" state={"Gainers"} className="hover:text-[#3F72AF]">
                      Gainers
                    </NavLink>
                    <NavLink to="/PreWorkouts" state={"PrePostWorkouts"} className="hover:text-[#3F72AF]">
                      Pre Workouts
                    </NavLink>
                    <NavLink to="/PostWorkouts" state={"PrePostWorkouts"} className="hover:text-[#3F72AF]">
                      Post Workouts
                    </NavLink>
                    <NavLink to="/Vitamins" state={"Vitamins"} className="hover:text-[#3F72AF]">
                      Vitamin Supplements
                    </NavLink>
                    <NavLink to="/ActiveWear" state={"ActiveWear"} className="hover:text-[#3F72AF]">
                      Active Wear
                    </NavLink>
                  </ul>
                </div>
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2 lg:static lg:translate-x-0">
              <NavLink to="/">
                <img src="/logo-main.png" alt="VitalGear Logo" className="h-12 w-auto" />
              </NavLink>
            </div>
